class Platformer2 extends Phaser.Scene {
    ...
    create() {
        ...
        this.map = this.add.tilemap("monochrome_level_2", 16, 16, 200, 20);

        // Add a tileset to the map
        // First parameter: name we gave the tileset in Tiled
        // Second parameter: key for the tilesheet (from this.load.image in Load.js)
        this.tileset = this.map.addTilesetImage("monochrome_tilemap", "monochrome");
      ...
      //  this.platformLayer.setScale(2.0);
        ...
        birds.get(20, 30, "bird_Idle").setFlip(true, false);
        birds.get(450, 30, "bird_Idle");
        birds.get(500, 200, "bird_Idle");
        birds.get(700, 30, "bird_Idle");
        birds.get(900, 30, "bird_Idle");
        birds.get(1137, 200, "bird_Idle").setFlip(true, false);

        birds.get(1370, 200, "bird_Idle");
        birds.get(1621, 200, "bird_Idle");
        birds.get(1541, 35, "bird_Idle").setFlip(true, false);
        birds.get(1837, 190, "bird_Idle").setFlip(true, false);
        birds.get(2155, 130, "bird_Idle");
        birds.get(2328, 200, "bird_Idle");
        birds.get(2680, 200, "bird_Idle");
        birds.get(2857, 200, "bird_Idle");
        birds.get(3080, 250, "bird_Idle");
